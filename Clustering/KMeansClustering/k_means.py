...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 12 11:15:58 2018
...
plt.scatter(X[y_kmeans == 3, 0], X[y_kmeans == 3, 1], color = 'magenta', label = 'Cluster 4')
plt.scatter(X[y_kmeans == 4, 0], X[y_kmeans == 4, 1], color = 'cyan', label = 'Cluster 5')
plt.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], color = 'black', label = 'Centroid', s = 20)
